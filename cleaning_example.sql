...
/*
I chose the this data set for a couple of reasons. The first being that the data 
scientist data set was used for examples within the lectures. Although this isn't 
necessarily a bad thing, I wanted a fresh data set that did not already have 
examples made of, as well as any biases I formed watching the lectures. Secondly, 
I chose this data set because I immediately saw some areas to work on. This includes 
an already existing system for denoting null values as 'nan' used for question 1-2.
There are also a couple of columns with common groups with different spellings such
as fav_cuisine for question 3. A new cleaning for question 4 could include changing
one of the dummy coded variables that denote a numeric value into their respective
values to allow for aggregate functions to be performed on it.
*/
